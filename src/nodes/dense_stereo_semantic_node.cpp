...
int main(int argc, char** argv) {
  ros::init(argc, argv, "dense_stereo_semantic_node");
 ...
 // XmlRpc::XmlRpcValue depth_params;
  ...
  depth_remap["rect/semantic/image"] = ros::names::resolve("rect/semantic/image");
  ...
  manager.load(depth_name, "image_undistort/DepthSemanticNodelet", depth_remap, nargv);
