...
class DepthSemantic {
 public:
  DepthSemantic(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private);
  ...
  void camerasCallback(
      ...
      const sensor_msgs::ImageConstPtr& semantic_image_msg_in,
 ...
 private:
  ...
  void calcPointCloud(const cv::Mat& input_disparity, const cv::Mat& left_image, const cv::Mat& semantic_image,
  ...
  image_transport::SubscriberFilter semantic_image_sub_;
  ...
  typedef message_filters::sync_policies::ApproximateTime<
      sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::Image, sensor_msgs::CameraInfo,
